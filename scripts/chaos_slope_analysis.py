...
SYSTEMS = [
    # (name, family, x0, dt)
    ('lorenz63',         'flow_dissipative',  [1.,1.,1.],              0.01),
    ('rossler',          'flow_dissipative',  [1.,1.,0.],              0.05),
    ('duffing_forced',   'flow_dissipative',  [0.5,0.,0.],             0.05),
    ('lorenz96_n5',      'flow_dissipative',  [8.,8.,8.,8.01,8.],      0.02),
    ('aizawa',           'flow_dissipative',  [0.1,0.,0.],             0.01),
    ('sprott_b',         'flow_dissipative',  [0.05,0.05,0.],          0.02),
    ('halvorsen',        'flow_dissipative',  [-5.,0.,0.],             0.01),
    ('thomas',           'flow_dissipative',  [0.1,0.,0.],             0.05),
    ('chen',             'flow_dissipative',  [-10.,0.,37.],           0.005),
    ('ueda_forced',      'flow_dissipative',  [2.5,0.,0.],             0.05),
    ('lorenz96_n10',     'flow_dissipative',  [8.,8.,8.,8.01,8.,8.,8.,8.,8.,8.], 0.02),
    ('double_pendulum',  'flow_hamiltonian',  [1.0,-1.0,0.5,-0.5],    0.005),
    ('henon_heiles',     'flow_hamiltonian',  [0.,0.35,0.35,0.],       0.01),
    ('cr3bp_earth_moon', 'flow_hamiltonian',  [0.9,0.,0.,1.8],         0.001),
    ('yang_mills_x2y2',  'flow_hamiltonian',  [1.,1.,0.5,0.5],         0.01),
    ('pullen_edmonds',   'flow_hamiltonian',  [0.5,0.5,0.3,-0.3],      0.02),
    ('quartic_coupled',  'flow_hamiltonian',  [1.,1.,0.,0.],           0.01),
    ('spring_pendulum',  'flow_hamiltonian',  [1.5,0.1,0.,0.1],        0.005),
    ('coupled_duffing_ham','flow_hamiltonian',[1.0,-1.0,0.,0.],        0.01),
    ('logistic_r3p9',    'map',               [0.6],                   1.),
    ('henon_map',        'map',               [0.,0.],                 1.),
    ('standard_map_K1p2','map',               [0.5,0.5],               1.),
    ('mackey_glass',     'flow_delay',        [0.9],                   0.1),
    ('harmonic',         'control',           [1.,0.],                 0.05),
    ('quasiperiodic_2tori','control',         [1.,0.],                 0.05),
    ('random_walk',      'control',           [0.,0.],                 1.),
]
